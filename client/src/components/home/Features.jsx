...
const Features = () => {
    const featureItems = [
        ...
        {
            icon: <svg className="size-6 stroke-orange-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 15V3" /><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="m7 10 5 5 5-5" /></svg>,
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title="Build your Resume" description='Smart, fast, and simple resume creation powered by AI.'/>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                <div className="px-4 md:px-0">
                    {featureItems.map((item, index) => (
                        <div
                            key={index}
                            className="flex items-center justify-center gap-6 max-w-md group cursor-pointer p-2"
                        >
                            <div className={`p-6 flex gap-4 rounded-xl transition-colors border border-transparent group-hover:bg-${item.color}-100 group-hover:border-${item.color}-300`}>
                                {item.icon}
                                <div className="space-y-2">
                                    <h3 className="text-base font-semibold text-slate-700">{item.title}</h3>
